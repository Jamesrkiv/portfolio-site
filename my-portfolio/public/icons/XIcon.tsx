...
const XIcon = ({size = 16, fill = "currentColor", className = ""}: Props) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={fill} className={className} viewBox="0 0 24 24">
